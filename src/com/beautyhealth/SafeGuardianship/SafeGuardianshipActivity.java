package com.beautyhealth.SafeGuardianship;
...
import com.beautyhealth.SafeGuardianship.BooldSugarGuardianship.Activity.BloodSugarGuardianshipActivity;
import com.beautyhealth.SafeGuardianship.LocationGuardianship.Activity.TimeLocationActivity;

public class SafeGuardianshipActivity extends NavAndTabBarActivity implements OnClickListener{
	 private TabBarFragment tabBarFragment;
	 private ImageButton bloodpressure,bloodsugar,ability,mylocation;
	 private long firstBackKeyTime = 0;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_safeguardianship);
		initNavBar("安全监护", null, null);
		fetchUIFromLayout();
		setListener();
	}
	...
	private void setListener() {
		...
		ability.setOnClickListener((OnClickListener) this);
		mylocation.setOnClickListener((OnClickListener) this);
		
	}

	private void fetchUIFromLayout() {
		bloodpressure = (ImageButton) findViewById(R.id.btn_pressure_guardianship);
		bloodsugar = (ImageButton) findViewById(R.id.btn_sugar_guardianship);
		ability = (ImageButton) findViewById(R.id.btn_action_guardianship);
		mylocation = (ImageButton) findViewById(R.id.btn_location_guardianship);
	...
	public void onClick(View v) {
		...
		case R.id.btn_pressure_guardianship:
			...
			intent.setClass(getApplicationContext(), BloodPressureGuardianshipActivity.class);
			startActivity(intent);	
/*			overridePendingTransition(R.anim.slide_up_in,
					R.anim.slide_down_out);*/
			break;
		case R.id.btn_sugar_guardianship:
			intent.setClass(getApplicationContext(), BloodSugarGuardianshipActivity.class);
			startActivity(intent);
/*			overridePendingTransition(R.anim.slide_up_in,
					R.anim.slide_down_out);*/
			break;
		case R.id.btn_action_guardianship:
			...
			intent.setClass(getApplicationContext(), SafeActionActivity.class);
			startActivity(intent);
/*			overridePendingTransition(R.anim.slide_up_in,
					R.anim.slide_down_out);*/
			break;
		case R.id.btn_location_guardianship:
			...
			intent.setClass(getApplicationContext(), TimeLocationActivity.class);
			startActivity(intent);
/*			overridePendingTransition(R.anim.slide_up_in,
					R.anim.slide_down_out);*/
			break;		
