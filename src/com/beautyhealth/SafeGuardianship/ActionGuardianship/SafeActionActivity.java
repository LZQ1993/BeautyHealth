...
import com.beautyhealth.PersonHealth.Pedometer.DisplayUtil;
...
public class SafeActionActivity extends DataRequestActivity {
	...
	private void InitData() {
		ISqlHelper isqlHelper = new SqliteHelper(null, SafeActionActivity.this);
		...
		if (ls.size() > 0) {
			...
			UserID = um.UnderGuardUserID;
			SimpleDateFormat sDateFormat = new SimpleDateFormat("yyyy-MM");
			String Time = sDateFormat.format(new java.util.Date());
			String stime = Time + "-01 " + "00:00:00";
			String etime = Time + "-31 " + "23:59:59";
			ToastUtil.show(getApplicationContext(), "被监护人：" + um.UserName);
	...
	private void showDialog() {
		...
		startTime.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(SafeActionActivity.this,
		...
		// 对话框
		new AlertDialog.Builder(SafeActionActivity.this).setView(itemview)
				.setTitle("提示：输入条件")
				.setPositiveButton("确定", new Dialog.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (startTime.getText().toString().equals("")||endTime
							...
							ToastUtil.show(SafeActionActivity.this, "查询信息不能为空");
							
						} else {
							SeachStep(startTime.getText().toString(), endTime
