package com.beautyhealth.SafeGuardianship.BooldSugarGuardianship.Activity;
...
public class BloodSugarGuardianshipActivity extends DataRequestActivity{
	...
	private void InitData() {
		ISqlHelper isqlHelper = new SqliteHelper(null,
				BloodSugarGuardianshipActivity.this);
		 ...
		 private void showDialog(){ 	 
				...
				startTime.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						new DatePickerDialog(BloodSugarGuardianshipActivity.this,
		        ...
		        //对话框
		        new AlertDialog.Builder(BloodSugarGuardianshipActivity.this)
		        .setView(itemview)
		        .setTitle("提示：输入条件")
		        .setPositiveButton("确定", new Dialog.OnClickListener() {
		            ...
		            public void onClick(DialogInterface dialog, int which) {	
		            	if (startTime.getText().toString().equals("")||endTime
							...
							ToastUtil.show(BloodSugarGuardianshipActivity.this, "查询信息不能为空");
