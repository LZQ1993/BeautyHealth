...
import com.beautyhealth.PrivateDoctors.Util.BitmapCache;
import com.beautyhealth.PrivateDoctors.Util.BitmapCache.ImageCallback;
...
public class AlbumGridViewAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		for(int i=0;i<dataList.size();i++){
			Log.e("sssssb", dataList.get(i).imagePath+"--"+dataList.get(i).thumbnailPath);
		}
		for(int i=0;i<selectedDataList.size();i++){
			Log.e("sssssa", selectedDataList.get(i).imagePath+"--"+selectedDataList.get(i).thumbnailPath);
		}
		return convertView;
	}
