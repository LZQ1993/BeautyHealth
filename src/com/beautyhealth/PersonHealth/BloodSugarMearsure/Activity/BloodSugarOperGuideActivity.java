...
public class BloodSugarOperGuideActivity extends NavAndTabBarActivity implements
		ViewFactory, OnTouchListener, OnClickListener {
	/**
	 * ImagaSwitcher 的引用
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bloodsugar_operationguide);
	...
	private void fetchUIFromLayout() {
		...
		imgIds = new int[] { R.drawable.sugar_pic1,R.drawable.sugar_pic2,R.drawable.sugar_pic3,R.drawable.sugar_pic4,R.drawable.sugar_pic5
				,R.drawable.sugar_pic6,R.drawable.sugar_pic7,R.drawable.sugar_pic8,R.drawable.sugar_pic9
				,R.drawable.sugar_pic10,R.drawable.sugar_pic11,R.drawable.sugar_pic12,R.drawable.sugar_pic13,R.drawable.sugar_pic14,R.drawable.sugar_pic15
				,R.drawable.sugar_pic16,R.drawable.sugar_pic17,R.drawable.sugar_pic18};
